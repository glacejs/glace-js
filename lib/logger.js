...
winston.add(winston.transports.File, { filename: CONF.log.file })
 ...
 *
 * @function
 * @arg {string} testName - Name of testcase.
 */
winston.testCase = testName => {
    var logsDir = path.resolve(CONF.reportDir,
                               _.kebabCase(testName),
                               "logs");
    mkdirp.sync(logsDir);
