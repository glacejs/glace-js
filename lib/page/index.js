 ...
 *
 * @method
 * @arg {string} hostUrl - URL of host where page is located.
 */
Page.prototype.open = function (hostUrl) {
    var fullUrl = url.resolve(hostUrl, this.url);
    return this._getDriver().url(fullUrl);
};
