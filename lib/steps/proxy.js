...
module.exports = {
    ...
    stopProxy: async function (opts) {
        ...
        if (!this._proxy) {
            logger.stepDebug("Step to stop proxy will be skipped, " +
                             "because step to start proxy wasn't passed");
            return;
        };
    ...
    stopGlobalProxy: async function (opts) {
        ...
        if (!this._globalProxy) {
            logger.stepDebug(
                "Step to stop global proxy will be skipped, " +
                "because step to start global proxy wasn't passed");
            return;
        };
